...
function Person(name, age, gender) {
  ...
  this.name = name,
    this.age = age,
    this.gender = gender,
    Object.defineProperty(this, "gender", { writable: false }),
    this.children = [],
...
let descriptorIvan = Object.getOwnPropertyDescriptor(ivan, 'gender'); // посмотреть дескрипторы для gender
console.log(`*******************`);
console.log(`Дескриптор для ivan.gender:`);
